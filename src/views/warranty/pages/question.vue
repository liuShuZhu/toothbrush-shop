<template>
  <SectionFull class="bannerBox  min-h-screen py-12 md:py-20 px-4  flex flex-col items-center justify-center  bg-[#f6fbf9]">
    ...
    <div class="text-sm leading-6 mt-1 text-[#01799c] underline">Click to light up stars on Amazon NOW</div>
    <a href="https://www.amazon.com/review/create-review?" target="_blank" class="text-sm leading-6 mt-1 text-[#1d1d1d] flex items-center"><QuestionMarkCircleIcon class="h-4 w-4 inline-block text-[#01799c]" />No link?A tip to review on Amazon APP</a>
